                ...
                ->afterStateUpdated(function ($state, callable $set, callable $get) {
                    ...
                    foreach ($students as $key => $student) {
                        ...
                        if ($group) {
                            ...
                            $students[$key]['instructor_id'] = $group->instructor_id;
                        }
                    }
                        ...
                        ->schema([
                            TextInput::make('name')
                                ...
                                ->rule(function (Get $get) {
                                    return Rule::unique('students', 'name');
                                    // Ensure 'students' is your database
                                }),
                            ...
                            Select::make('group_id')
                                ...
                                ->searchable()
                                ->disabled(fn ($get) => ! is_null($get('../../global_group_id')))
                                // ->hidden(fn ($get) => !is_null($get('../../global_group_id')))
                                ->hidden()
                                ->required()
                                ->validationMessages([
                                ...
                                ->afterStateUpdated(function ($state, callable $set) {
                                    ...
                                    if ($group) {
                                        ...
                                        $set('instructor_id', $group->instructor_id);
                                    }
                                }),
                            ...
                            TextInput::make('phone')
                                ...
                                ->rule(function (Get $get) {
                                    return Rule::unique('students', 'phone');
                                    // Ensure 'students' is your database
                                })
                                ->inputMode('tel')
